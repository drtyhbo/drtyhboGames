                     ...
                     device:(id<MTLDevice>)device
{
    ...
    __block CGPoint minPoint = CGPointMake(CGFLOAT_MAX, CGFLOAT_MAX);
    __block CGPoint maxPoint = CGPointMake(CGFLOAT_MIN, CGFLOAT_MIN);
    ...
    _rect = CGRectMake(minPoint.x, minPoint.y, maxPoint.x - minPoint.x, maxPoint.y - minPoint.y);
